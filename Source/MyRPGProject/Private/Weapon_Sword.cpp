...
void AWeapon_Sword::AttackSword(int32 damage, float TraceDistance, UParticleSystem* Particle)
{
	...
	if (MyOwner)
	{
		...
		const FVector TraceEnd = TraceStart + (MyOwner->GetActorForwardVector() * TraceDistance); // 150.0f
